...
// Real subscriber/referral names supplied for the "trusted by" scroll —
// shown as a plain name list, not attributed quotes (no testimonial text
// was provided per person).
export const TRADER_NAMES: string[] = [
  "Veeramanikandan",
  "A Sindhuja",
  "Perumal Madhumani",
  "Pavithran Krishnan",
  "Madesh Kaliyappan",
  "Madhappan Balaji",
  "Aadhithya Matheswaran",
  "Nishanth Fredrick",
  "Subramanian Nirmala",
  "Selvam Murali Muthamil",
  "Hariprasath Senthilkumar",
  "Kiran Venkataraj",
  "Prabu",
  "Perumal Loganathan",
  "Shanmugam Prabhu",
  ...
  "Rajamanickam Ramesh",
  "Rajan Pradeepkumar",
  "Loganathan Ravikumar",
  "U Sunil Kumar",
  "Kavitha Ramu",
  "Mohammad Sindha Mydeen",
  "Udayakumar Sankar",
  "Murugan Aravindan",
  "Mohamed Farook",
  "Jayaraman Manimaran",
  "Mohan Kumar",
  "Vimalkumar Palanisamy",
  "Manikandan P",
  "Neelavathamma",
  "Jayaraman Nagaraj",
  "Padmanabhan Seethalakshmi",
  "Elumalai Ragul",
  "Arunkumar Parthiban",
  "Kiruba Shankar",
  "Prabhadevi T",
  "Sathya U",
  "Karthickraja",
  "Ponnusamy Mathankumar",
  "Mohammed Sahulhameed S",
  "Rajendran Sudha",
